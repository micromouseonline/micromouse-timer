...
#elif (defined(ARDUINO_AVR_MEGA) || defined(ARDUINO_AVR_MEGA1280) || defined(ARDUINO_AVR_MEGA2560) || defined(__AVR_ATmega1280__) || \
                            ...
                            : ((((P) >= 0 && (P) <= 3) || (P) == 5)                                    \
                                   ...
                                   : (((P) >= 54 && (P) <= 61)                                         \
                                          ...
                                          : ((((P) >= 39 && (P) <= 41) || (P) == 4)                    \
                                                 ...
                                                 : ((((P) >= 6 && (P) <= 9) || (P) == 16 || (P) == 17) \
                                                        ? &PORTH                                       \
                                                        : (((P) == 14 || (P) == 15) ? &PORTJ : (((P) >= 62 && (P) <= 69) ? &PORTK : &PORTL))))))))))
                            ...
                            : ((((P) >= 0 && (P) <= 3) || (P) == 5)                                    \
                                   ...
                                   : (((P) >= 54 && (P) <= 61)                                         \
                                          ...
                                          : ((((P) >= 39 && (P) <= 41) || (P) == 4)                    \
                                                 ...
                                                 : ((((P) >= 6 && (P) <= 9) || (P) == 16 || (P) == 17) \
                                                        ? &DDRH                                        \
                                                        : (((P) == 14 || (P) == 15) ? &DDRJ : (((P) >= 62 && (P) <= 69) ? &DDRK : &DDRL))))))))))
                            ...
                            : ((((P) >= 0 && (P) <= 3) || (P) == 5)                                    \
                                   ...
                                   : (((P) >= 54 && (P) <= 61)                                         \
                                          ...
                                          : ((((P) >= 39 && (P) <= 41) || (P) == 4)                    \
                                                 ...
                                                 : ((((P) >= 6 && (P) <= 9) || (P) == 16 || (P) == 17) \
                                                        ? &PINH                                        \
                                                        : (((P) == 14 || (P) == 15) ? &PINJ : (((P) >= 62 && (P) <= 69) ? &PINK : &PINL))))))))))
...
#define __digitalPinToPortReg(P) (((P) >= 0 && (P) <= 7) ? &PORTB : (((P) >= 8 && (P) <= 15) ? &PORTD : (((P) >= 16 && (P) <= 23) ? &PORTC : &PORTA)))
#define __digitalPinToDDRReg(P) (((P) >= 0 && (P) <= 7) ? &DDRB : (((P) >= 8 && (P) <= 15) ? &DDRD : (((P) >= 8 && (P) <= 15) ? &DDRC : &DDRA)))
#define __digitalPinToPINReg(P) (((P) >= 0 && (P) <= 7) ? &PINB : (((P) >= 8 && (P) <= 15) ? &PIND : (((P) >= 8 && (P) <= 15) ? &PINC : &PINA)))
#define __digitalPinToBit(P) (((P) >= 0 && (P) <= 7) ? (P) : (((P) >= 8 && (P) <= 15) ? (P)-8 : (((P) >= 16 && (P) <= 23) ? (P)-16 : (P)-24)))
...
#elif (defined(ARDUINO_AVR_UNO) || defined(ARDUINO_AVR_DUEMILANOVE) || defined(__AVR_ATmega168__) || defined(__AVR_ATmega168A__) || \
...
#define __digitalPinToPortReg(P) (((P) >= 0 && (P) <= 7) ? &PORTD : (((P) >= 8 && (P) <= 13) ? &PORTB : (((P) >= 14 && (P) <= 19) ? &PORTC : &PORTE)))
#define __digitalPinToDDRReg(P) (((P) >= 0 && (P) <= 7) ? &DDRD : (((P) >= 8 && (P) <= 13) ? &DDRB : (((P) >= 14 && (P) <= 19) ? &DDRC : &DDRE)))
#define __digitalPinToPINReg(P) (((P) >= 0 && (P) <= 7) ? &PIND : (((P) >= 8 && (P) <= 13) ? &PINB : (((P) >= 14 && (P) <= 19) ? &PINC : &PINE)))
#define __digitalPinToBit(P) \
  (((P) >= 0 && (P) <= 7) ? (P) : (((P) >= 8 && (P) <= 13) ? (P)-8 : (((P) >= 14 && (P) <= 19) ? (P)-14 : (((P) >= 20 && (P) <= 21) ? (P)-18 : (P)-22))))
#else
#define __digitalPinToPortReg(P) (((P) >= 0 && (P) <= 7) ? &PORTD : (((P) >= 8 && (P) <= 13) ? &PORTB : &PORTC))
#define __digitalPinToDDRReg(P) (((P) >= 0 && (P) <= 7) ? &DDRD : (((P) >= 8 && (P) <= 13) ? &DDRB : &DDRC))
#define __digitalPinToPINReg(P) (((P) >= 0 && (P) <= 7) ? &PIND : (((P) >= 8 && (P) <= 13) ? &PINB : &PINC))
